...
const BEP20DecimalsMock = artifacts.require('BEP20DecimalsMock');
...
contract('BEP20', function (accounts) {
  ...
  beforeEach(async function () {
    this.token = await BEP20Mock.new(name, symbol, initialHolder, initialSupply);
  });
  ...
  describe('set decimals', function () {
    ...
    it('can set decimals during construction', async function () {
      const token = await BEP20DecimalsMock.new(name, symbol, decimals);
      expect(await token.decimals()).to.be.bignumber.equal(decimals);
    });
  });

  shouldBehaveLikeBEP20('BEP20', initialSupply, initialHolder, recipient, anotherAccount);
  ...
  describe('_mint', function () {
    ...
    it('rejects a null account', async function () {
      await expectRevert(this.token.mint(ZERO_ADDRESS, amount), 'BEP20: mint to the zero address');
    });
  ...
  describe('_burn', function () {
    it('rejects a null account', async function () {
      await expectRevert(this.token.burn(ZERO_ADDRESS, new BN(1)), 'BEP20: burn from the zero address');
    });

    describe('for a non zero account', function () {
      it('rejects burning more than balance', async function () {
        await expectRevert(this.token.burn(initialHolder, initialSupply.addn(1)), 'BEP20: burn amount exceeds balance');
      });
  ...
  describe('_transfer', function () {
    shouldBehaveLikeBEP20Transfer('BEP20', initialHolder, recipient, initialSupply, function (from, to, amount) {
  ...
  describe('_approve', function () {
    shouldBehaveLikeBEP20Approve('BEP20', initialHolder, recipient, initialSupply, function (owner, spender, amount) {
