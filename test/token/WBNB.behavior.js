...
function shouldBehaveLikeBEP20(errorPrefix, initialSupply, initialHolder, recipient, anotherAccount) {
  ...
  describe('transfer', function () {
    shouldBehaveLikeBEP20Transfer(errorPrefix, initialHolder, recipient, initialSupply, function (from, to, value) {
...
function shouldBehaveLikeBEP20Transfer(errorPrefix, from, to, balance, transfer) {
  describe('when the recipient is not the zero address', function () {
